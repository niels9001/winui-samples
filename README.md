...
| [TouchKeyboard](https://github.com/microsoft/Windows-universal-samples/tree/main/Samples/TouchKeyboard) | [TouchKeyboard](https://github.com/niels9001/winui-samples/tree/main/Samples/TouchKeyboard) | 5 scenarios across two groups. Touch keyboard: auto-display on focus with a custom TextBox-derived control; listen for Showing/Hiding events; TryShow/TryHide methods. Text input: spell check / text suggestions; InputScope scoped views. Consolidates the former TouchKeyboardTextInput sample. |
| [TouchKeyboardTextInput](https://github.com/microsoft/Windows-universal-samples/tree/main/Samples/TouchKeyboardTextInput) | [TouchKeyboard](https://github.com/niels9001/winui-samples/tree/main/Samples/TouchKeyboard) (consolidated) | Spell check / text suggestions and InputScope scoped views, merged into the TouchKeyboard sample as a "Text input" feature group. |
...
| [Calendar](https://github.com/microsoft/Windows-universal-samples/tree/main/Samples/Calendar) | Uses Windows.Globalization.Calendar, which still works in WinUI 3. |
...
| [SystemMediaTransportControls](https://github.com/microsoft/Windows-universal-samples/tree/main/Samples/SystemMediaTransportControls) | Uses Windows.Media.SystemMediaTransportControls, which still works in WinUI 3. |
...
| [AdaptiveStreaming](https://github.com/microsoft/Windows-universal-samples/tree/main/Samples/AdaptiveStreaming) | Adaptive streaming playback (AdaptiveMediaSource for HLS/DASH); deferred to a later media pass. Basic MediaPlayerElement playback is shown in the WinUI 3 Gallery. |
