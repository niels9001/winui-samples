...
namespace SDKTemplate
{
    ...
    public sealed partial class Scenario12 : Page
    {
        ...
        private async void Scenario12Button_Show_Click(object sender, RoutedEventArgs e)
        {
            ...
            //   1. Get a ResourceContext on the UI thread using CreateResourceContext and pass 
            //      to the non-UI thread
            //   2. Get a ResourceContext on the non-UI thread using CreateResourceContext
            //
            ...
            ResourceContext defaultContextForUiThread = new ResourceManager().CreateResourceContext();
            ...
            await Windows.System.Threading.ThreadPool.RunAsync(
                (source) =>
                {
                    ResourceMap stringResourceMap = new ResourceManager().MainResourceMap.GetSubtree("Resources");
                    ...
                    ResourceContext defaultViewIndependentResourceContext = new ResourceManager().CreateResourceContext();

                    // NOTE: The ResourceContext obtained using CreateResourceContext() has no scale qualifier
                    ...
                    // But if the scale qualifier is reset (e.g., using the creating a new ResourceContext), then
