...
namespace SDKTemplate
{
    ...
    public sealed partial class Scenario8 : Page
    {
        ...
        {
            ResourceContext defaultContextForCurrentView = new ResourceManager().CreateResourceContext();
            ResourceMap stringResourcesResourceMap = new ResourceManager().MainResourceMap.GetSubtree("Resources");
